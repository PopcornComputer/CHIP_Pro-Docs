...
If you want to add or modify a document, add your markdown file to the [includes](https://github.com/NextThingCo/Crumb-Docs/tree/master/source/includes) directory and make a pull request. You can use [Github markdown](https://help.github.com/articles/github-flavored-markdown/) or [regular markdown](https://daringfireball.net/projects/markdown/syntax). 
...
This repo is [forked from Slate](https://github.com/lord/slate). Read the docs on the original Slate repo [wiki](https://github.com/lord/slate/wiki) if you want all the details. There are also some [sample docs](http://tripit.github.io/slate) worth perusing.
...
### Print
A printable version can be perfected by modifying the file `source/stylesheets/print.css.scss` and printing to a PDF.
